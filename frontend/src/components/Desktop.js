...
const Desktop = () => {
  ...
  const handleAppOpen = useCallback(
    (appId) => {
      ...
      const appConfigs = {
        about: {
          title: "About - Sangeeta Prajapati 2025",
          content: <AboutContent />,
          initialSize: { width: 800, height: 600 },
        },
        projects: {
          title: "Projects - Sangeeta's Projects 2025",
          content: <Project />,
          initialSize: { width: 1200, height: 800 },
        },
        // Map project-specific IDs to the projects window
        "healthcare-app": {
          title: "Projects - Sangeeta's Project 2025",
          content: <Project />,
          initialSize: { width: 1200, height: 800 },
        },
        "matchmaking-pro": {
        ...
        "project-1": {
          title: "Healthcare App - Sangeeta's Project 2025",
          content: <ProjectContent projectId="healthcare-app" />,
          initialSize: { width: 900, height: 700 },
        },
        "project-2": {
          title: "Matchmaking Pro - Sangeeta's Project 2025",
          content: <ProjectContent projectId="matchmaking-pro" />,
          initialSize: { width: 900, height: 700 },
        },
        "project-3": {
          title: "My Portfolio - Sangeeta's Project 2025",
          content: <ProjectContent projectId="portfolio" />,
          initialSize: { width: 900, height: 700 },
        },
        contact: {
          title: "Contact - Sangeeta's Portfolio 2025",
          content: <ContactContent />,
          initialSize: { width: 700, height: 600 },
        },
        finder: {
          title: "Finder - Sangeeta's Portfolio 2025",
          content: <FinderContent />,
          initialSize: { width: 900, height: 600 },
        },
        safari: {
          title: "Safari - Sangeeta's Portfolio 2025",
          content: (
        ...
        terminal: {
          title: "Terminal - Sangeeta's Portfolio 2025",
          content: (
            <div
              style={{
                padding: "20px",
