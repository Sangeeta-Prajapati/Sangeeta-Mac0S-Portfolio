...
const ContactContent = () => {
  ...
  const WEB3FORMS_ACCESS_KEY = "ca40b149-449c-4f13-bdb1-281a7431f38f";
  ...
  const socialLinks = [
    ...
    },
    {
      icon: '💼',
      title: 'LinkedIn',
      value: 'sangeeta-prajapati-496b64243',
      url: 'https://www.linkedin.com/in/sangeeta-prajapati-496b64243/'
    },
    {
      icon: '📷',
      title: 'Instagram',
    ...
    },
    {
      icon: '🐙',
      title: 'GitHub',
      value: 'Sangeeta-Prajapati',
      url: 'https://github.com/Sangeeta-Prajapati'
    }
  ];
