      ...
      >
        <div className="profile-section">
          <div className="profile-image">
            <img src="https://res.cloudinary.com/dfnj5fh0i/image/upload/v1748859724/BATMAN_2_gyxbqy.jpg" alt="Sangeeta Prajapati" />
          </div>
        ...
        <div className="contact-cta">
          ...
          <div className="cta-buttons">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open('mailto:sanjuother107@gmail.com')}
            >
              Get in Touch
            </motion.button>
            <motion.button 
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open('https://drive.google.com/file/d/1UWyThU8v72HRIBF7oLMESr3L5QTC-1-T/view?usp=sharing')}
            >
              Download Resume
            </motion.button>
            <motion.button 
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open('https://github.com/Sangeeta-Prajapati')}
            >
              View GitHub
            </motion.button>
          </div>
